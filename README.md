...
This dataset contains 3 types of surface defects: Oil, Scratch and Stain. It consists of 1200 images and 400 images for each defects. The defects are artificially generated. The images are collected by industrial camera and the resolution is 1920*1080. The dataset is divided into train:val:test=6:2:2. The dataset format of is PASCAL VOC.<br/>
The dataset is made and presented by Open Lab on Human Robot Interaction, Peking University. <br/>
Download(Google Drive): MSSDD; [Visualiztion.zip(70.MB)](https://drive.google.com/file/d/1XcZynrTgl3B8wQif2eAKoZxc8A-R06Mq/view?usp=sharing) for visualization.<br/>
